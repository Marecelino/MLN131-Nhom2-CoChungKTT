...
const CourseDetailPage: React.FC = () => {
  ...
  const { completedLessons, toggleLesson, progress } = useCourseProgress(course.lessons.length);
      ...
      <div className="course-detail-page container">
        ...
        <div className="course-detail-grid">
            ...
            <aside className="progress-sidebar">
                <ProgressStats progressPercentage={progress} completedCount={completedLessons.size} totalCount={course.lessons.length} />
            </aside>
        </div>
      </div>
