...
export const persons: Person[] = [
  ...
  },
  {
    ...
    bio: 'Quốc sư Vạn Hạnh (932 – 1018), họ Nguyễn, quê ở làng Dịch Bảng, châu Cổ Pháp, nay thuộc huyện Từ Sơn, tỉnh Bắc Ninh.Năm 21 tuổi, Ngài xuất gia tu học tại chùa Tiêu Sơn với Thiền sư Đạo Giả, tinh thông Tam học (Giới – Định – Tuệ) và pháp môn Tổng Trì Tam Ma Địa, đạt trình độ thiền định và trí tuệ uyên thâm.Là bậc thiền sư kiệt xuất, Ngài đồng thời là nhà tiên tri, chính trị gia và cố vấn cho ba triều đại: Đinh – Tiền Lê – Lý.Trong triều Lê Đại Hành, Vạn Hạnh được trọng dụng, từng dự đoán chính xác chiến thắng trước quân Tống (981) và khuyên vua Lê xuất quân đánh Chiêm Thành, giúp Đại Việt giữ vững biên cương.Sau khi triều Tiền Lê suy yếu, Ngài cùng Thiền sư Đa Bảo và Đào Cam Mộc chủ trương đưa Lý Công Uẩn lên ngôi, mở ra triều đại Nhà Lý (1009 – 1225).Ngài cũng là người hiến kế cho Lý Thái Tổ dời đô từ Hoa Lư ra Thăng Long (1010) – một quyết định lịch sử tạo nền móng cho nền văn minh Đại Việt thịnh vượng suốt nhiều thế kỷ.Vạn Hạnh là người nuôi dạy và dẫn dắt Lý Công Uẩn từ thuở nhỏ, được tôn xưng là “Quốc sư” – thầy của nhà vua, là biểu tượng trí tuệ và đạo hạnh của Phật giáo Đại Việt.Ngài viên tịch năm 1018, thọ 90 tuổi, để lại bài kệ phó chúc nổi tiếng về lẽ vô thường và tâm thái an nhiên trước thịnh suy của cuộc đời:“Thân như bóng,chớp có rồi không,Cây cỏ xuân tươi thu đượm hồng,Mặc vận thạnh suy không sợ hãi,Thạnh suy đầu cỏ hạt sương đong.”Xá lợi của Ngài được an trí tại bảo tháp chùa Tiêu Sơn (Bắc Ninh).Tên tuổi và công đức của Quốc sư Vạn Hạnh được khắc ghi trong lịch sử như biểu tượng trí tuệ – nhân cách – và công lao dựng xây quốc gia Đại Việt.',
    contributions: [
